		...
		<!--link rel="stylesheet" type="text/css" href="style/logged_user_home.css"-->

		<link rel="stylesheet" type="text/css" href="include/flaticons/flaticon.css">
		
		<script type="text/javascript" src="jscript/logged_user_videos.js"></script>
	...
	<!--?php require("parts/wideVideoPlayer.php"); ?-->	
